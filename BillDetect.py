...
#     if cash == "20":
#         stream = p.open(
#             format=p.get_format_from_width(sound20.getsampwidth()),
...
#     elif cash == "50":
#         stream = p.open(
#             format=p.get_format_from_width(sound50.getsampwidth()),
...
#     elif cash == "100":
#         stream = p.open(
#             format=p.get_format_from_width(sound100.getsampwidth()),
...
#     elif cash == "500":
#         stream = p.open(
#             format=p.get_format_from_width(sound500.getsampwidth()),
...
#     elif cash == "1000":
#         stream = p.open(
#             format=p.get_format_from_width(sound1000.getsampwidth()),
...
def explore_match(win, img1, img2, kp_pairs, status=None, H=None):
    ...
    if H is not None:
        ...
        cv2.putText(
            vis, showText, (corners[0][0], corners[0][1]), font, 1, (0, 0, 255), 2
        )
    if status is None:
        status = np.ones(len(kp_pairs), np.bool_)

    p1 = np.int32([kpp[0].pt for kpp in kp_pairs])
    p2 = np.int32([kpp[1].pt + (w1, 0) for kpp in kp_pairs])
